...
Test various startup methods and functionalities of the module
"""
...
def test_environment():
    ...
    if not base_url:
        print("Tip: You can set environment variable WEKNORA_BASE_URL")

    if not api_key:
        print("Tip: It is recommended to set environment variable WEKNORA_API_KEY")
...
def test_package_installation():
    ...
    try:
        # Check if can be installed in development mode
        result = subprocess.run(
...
def main():
    """Run all tests"""
    print("WeKnora MCP Server Module Tests")
    print("=" * 50)
